 ...
 <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        ["Maintanence", 28.94, "#b87333"],
        ["Salary", 10.49, "silver"],
        ["Electric Bills", 19.30, "gold"],
        ["External Services", 25.45, "color: #e5e4e2"]
      ]);
  ...
  <script type="text/javascript">
   ...
   function drawChart() {
       ...
       dataTable.addRows([
          ...
          [ new Date(2018, 9, 4), 19 ],
          [ new Date(2018, 9, 4), 13 ],
          [ new Date(2018, 9, 4), 12 ],
          [ new Date(2018, 9, 4), 10 ],
          [ new Date(2018, 9, 5), 5],
          [ new Date(2018, 9, 12), 6],
          [ new Date(2018, 9, 13), 7],
          [ new Date(2018, 9, 19), 1 ],
          [ new Date(2018, 9, 23), 3],
          [ new Date(2018, 9, 24), 5],
